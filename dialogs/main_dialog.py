...
class MainDialog(ComponentDialog):
    ...
    async def act_step(self, step_context: WaterfallStepContext) -> DialogTurnResult:
        ...
        if intent == Intent.ORDER.value and luis_result:
        ...
        if intent == Intent.COMMENT.value:
            get_weather_text = "mother fucker"
            ...
            didnt_understand_text = (
                f"Sorry, I didn't get that. Please try asking in a different way intent:{intent}"
            )
    ...
    async def final_step(self, step_context: WaterfallStepContext) -> DialogTurnResult:
        ...
        if step_context.result is not None:
            ...
            msg_txt = f"You have {result.count} {result.food}."
